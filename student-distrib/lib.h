...
int screen_x;    // current X position of next text write
int screen_y;    // current Y position of next text write
...
/* interrupt testing function - increments the video memory */
